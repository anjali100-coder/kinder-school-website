    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 space-y-20">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <img src="/pic18.jpg" className="rounded-3xl shadow-2xl h-80 w-full object-cover" />
          <div>
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
          <div className="md:order-2">
            <img src="/pic17.jpg" className="rounded-3xl shadow-2xl h-80 w-full object-cover" />
          </div>
